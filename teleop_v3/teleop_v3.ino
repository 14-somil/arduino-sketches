#include <ros.h>
#include <beginner_tutorials/RoverMsg.h>
...
void messageCb(const beginner_tutorials::RoverMsg &msg) {
  lin_speed = msg.x;
  rot_speed = msg.y;
}

ros::Subscriber<beginner_tutorials::RoverMsg> sub("/rover", &messageCb);
