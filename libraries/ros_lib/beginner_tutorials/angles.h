#ifndef _ROS_SERVICE_angles_h
#define _ROS_SERVICE_angles_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ANGLES[] = "beginner_tutorials/angles";

  class anglesRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return ANGLES; };
    virtual const char * getMD5() override { return "0496e8c0c35c632938a659f27c1ce0a3"; };

  };

  class anglesResponse : public ros::Msg
  {
    public:
      typedef bool _check_type;
      _check_type check;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      u_check.real = this->check;
      *(outbuffer + offset + 0) = (u_check.base >> (8 * 0)) & 0xFF;
      offset += sizeof(this->check);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      u_check.base = 0;
      u_check.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->check = u_check.real;
      offset += sizeof(this->check);
     return offset;
    }

    virtual const char * getType() override { return ANGLES; };
    virtual const char * getMD5() override { return "c5df00fea9d1f39520fa0345cbde1b26"; };
